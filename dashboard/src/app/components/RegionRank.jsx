  ...
  return (
    <div className="stack-section">
      <div className="stack-heading">
        <span>全國案類構成比例</span>
        <small>點擊下方案類標籤可篩選統計範圍</small>
      </div>

      <div className="stacked-track national" aria-label="全國案類構成">
      ...
      <div className="topic-region-list" id="topic-regions">
        {displayedRegions.map((row, index) => (
          ...
          >
            ...
            <div className="stacked-track" aria-label={`${row.geography} ${activeTopic.label}案類構成`}>
