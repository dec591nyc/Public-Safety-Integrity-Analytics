  ...
  return (
    <div className="panel feedback-panel" data-view-panel="feedback">
      <div className="panel-head">
        <div>
          <h2>意見回饋與聯絡資訊</h2>
          <p>對本治安統計主題視覺化模組有任何改進建議？歡迎與我們聯絡</p>
        </div>
      </div>
      <div className="feedback-layout">
        <div className="feedback-block">
          <p style={{ margin: 0, fontSize: '13px', color: 'var(--muted-ink)' }}>
            本模組旨在協助民代、媒體輿論及社會大眾直觀地探索與勾稽警政署刑事統計，提升治安討論的數據品質。歡迎提供 any 視覺化改善建議。
          </p>
        ...
        <div className="feedback-block">
          <dl className="feedback-paths">
            ...
            <div>
              <dt>電子信箱</dt>
              <dd>feedback@crime-dashboard.gov.tw</dd>
            </div>
            <div>
              <dt>更新時效反映</dt>
              <dd>每年 12 個月數據與年度累計</dd>
            </div>
          </dl>
        </div>
      </div>
